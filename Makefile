...
build-docker:
	...
	docker image tag datalayer/agent-codemode:${VERSION} datalayer/agent-codemode:latest
...
start-docker:
	docker run -i --rm \
	  ...
	  --network=host \
	  datalayer/agent-codemode:latest

pull-docker:
	docker image pull datalayer/agent-codemode:latest

push-docker:
	docker push datalayer/agent-codemode:${VERSION}
	docker push datalayer/agent-codemode:latest
...
publish-pypi: # publish the pypi package
	...
	@exec echo
	@exec echo https://pypi.org/project/agent-codemode/#history
