...
├──────────────────────────┬──────────────────────────────────┤
│      agent-skills        │         agent-codemode           │  ◀── You are here
│  (skills management)     │  (tool generation from MCP/Skills)│
├──────────────────────────┴──────────────────────────────────┤
│                    code-sandboxes                           │
...
- ✅ Generate programmatic tools from MCP Servers (typed Python bindings)
- ✅ Generate programmatic tools from Skills (reusable compositions)
- ✅ Provide progressive tool discovery (search_tools, get_tool_details)
- ✅ Execute Python code that composes tools (CodeModeExecutor)
- ✅ Expose generated tools directly to agents or via MCP Server
...
See [MCP Servers](./mcp-servers/index.mdx) for complete documentation.
...
See [Tools Discovery](./discovery/index.mdx) for complete documentation.

### 🔌 Use Directly or Expose as MCP Server
