...
Agent Codemode provides progressive tool discovery to efficiently find relevant tools from the programmatic tools generated from [MCP Servers](../mcp-tools/index.mdx) and [Skills](../skills/index.mdx).
