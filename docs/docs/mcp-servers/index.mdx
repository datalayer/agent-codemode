...
│  (filesystem,   │     │   (discovers    │     │   from generated.mcp.X  │
...
Agent Codemode generates Python bindings in the `generated/mcp/` directory:
...
|------------|----------|-----------------|
| `filesystem` | `read_file` | `from generated.mcp.filesystem import read_file` |
| `web` | `fetch` | `from generated.mcp.web import fetch` |
| `database` | `query` | `from generated.mcp.database import query` |
...
async with CodeModeExecutor(registry) as executor:
    result = await executor.execute("""
        ...
        from generated.mcp.github import create_issue
...
- [Tools Discovery](../discovery/index.mdx) - Progressive tool discovery
